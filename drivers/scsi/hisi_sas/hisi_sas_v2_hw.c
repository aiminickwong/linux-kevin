...
#define CMD_HDR_ABORT_FLAG_MSK		0x3
#define CMD_HDR_ABORT_DEVICE_TYPE_OFF 2
#define CMD_HDR_ABORT_DEVICE_TYPE_MSK 0x4
#define CMD_HDR_RESP_REPORT_OFF		5
#define CMD_HDR_RESP_REPORT_MSK		0x20
#define CMD_HDR_TLR_CTRL_OFF		6
#define CMD_HDR_TLR_CTRL_MSK		0xc0
#define CMD_HDR_PORT_OFF			18
#define CMD_HDR_PORT_MSK			0x3c0000
...
#define CMD_HDR_DIR_MSK				0x60
#define CMD_HDR_RESET_OFF			7
#define CMD_HDR_RESET_MSK			0x80
#define CMD_HDR_VDTL_OFF			10
#define CMD_HDR_VDTL_MSK			0x400
#define CMD_HDR_FRAME_TYPE_OFF		11
#define CMD_HDR_FRAME_TYPE_MSK		0xf800
#define CMD_HDR_DEV_ID_OFF		16
#define CMD_HDR_DEV_ID_MSK		0xffff0000
/* dw2 */
#define CMD_HDR_CFL_OFF				0
#define CMD_HDR_CFL_MSK				0x1ff
#define CMD_HDR_NCQ_TAG_OFF			10
#define CMD_HDR_NCQ_TAG_MSK			0x7c00
#define CMD_HDR_MRFL_OFF			15
#define CMD_HDR_MRFL_MSK			0xff8000
#define CMD_HDR_SG_MOD_OFF			24
#define CMD_HDR_SG_MOD_MSK			0x3000000
#define CMD_HDR_FIRST_BURST_OFF		26
#define CMD_HDR_FIRST_BURST_MSK		0x4000000
/* dw3 */
#define CMD_HDR_IPTT_OFF		0
#define CMD_HDR_IPTT_MSK		0xffff
#define CMD_HDR_TPTT_OFF		16
#define CMD_HDR_TPTT_MSK		0xffff0000
/* dw6 */
...
#define CMPLT_HDR_ERR_PHASE_MSK			0x3f8
#define CMPLT_HDR_RSPNS_XFRD_OFF		10
#define CMPLT_HDR_RSPNS_XFRD_MSK		(1 << CMPLT_HDR_RSPNS_XFRD_OFF)
#define CMPLT_HDR_RSPNS_GOOD_OFF		11
#define CMPLT_HDR_RSPNS_GOOD_MSK		(1 << CMPLT_HDR_RSPNS_GOOD_OFF)
#define CMPLT_HDR_ERX_OFF			12
#define CMPLT_HDR_ERX_MSK			(1 << CMPLT_HDR_ERX_OFF)
#define CMPLT_HDR_ABORT_STAT_OFF		13
#define CMPLT_HDR_ABORT_STAT_MSK		(7 << CMPLT_HDR_ABORT_STAT_OFF)
/* abort_stat */
#define STAT_IO_NOT_VALID			0x1
#define STAT_IO_NO_DEVICE			0x2
#define STAT_IO_COMPLETE			0x3
#define STAT_IO_ABORTED				0x4
#define CMPLT_HDR_IO_CFG_ERR_OFF		16
#define CMPLT_HDR_IO_CFG_ERR_MSK		(0xffff << CMPLT_HDR_IO_CFG_ERR_OFF)
/* dw1 */
#define CMPLT_HDR_IPTT_OFF			0
#define CMPLT_HDR_IPTT_MSK			0xffff
#define CMPLT_HDR_DEV_ID_OFF			16
#define CMPLT_HDR_DEV_ID_MSK			0xffff0000
/* dw3 */
#define CMPLT_HDR_CFG_ERR_OFF			0
#define CMPLT_HDR_CFG_ERR_MSK			0xffff

/* ITCT header */
/* qw0 */
#define ITCT_HDR_DEV_TYPE_OFF			0
#define ITCT_HDR_DEV_TYPE_MSK			0x3
#define ITCT_HDR_VALID_OFF			2
#define ITCT_HDR_VALID_MSK			0x4
#define ITCT_HDR_BRE_OFF			3
#define ITCT_HDR_BRE_MSK			0x8
#define ITCT_HDR_AC_OFF				4
#define ITCT_HDR_AC_MSK				0x10
#define ITCT_HDR_MCR_OFF			5
#define ITCT_HDR_MCR_MSK			0x1e0
#define ITCT_HDR_VLN_OFF			9
#define ITCT_HDR_VLN_MSK			0x1e00
#define ITCT_HDR_SMP_TIMEOUT_OFF		16
#define ITCT_HDR_SMP_TIMEOUT_MSK		0xff0000
#define ITCT_HDR_PORT_ID_OFF			28
#define ITCT_HDR_PORT_ID_MSK			0xf0000000
#define ITCT_HDR_MBB_OFF			32
#define ITCT_HDR_MBB_MSK			0xffffffff00000000
/* qw1 */
#define ITCT_HDR_MAX_SAS_ADDR_OFF	0
#define ITCT_HDR_MAX_SAS_ADDR_MSK	0xffffffffffffffff
/* qw2 */
#define ITCT_HDR_INLT_OFF	0
#define ITCT_HDR_INLT_MSK	0xffff
#define ITCT_HDR_BITLT_OFF	16
#define ITCT_HDR_BITLT_MSK	0xffff0000
#define ITCT_HDR_MCTLT_OFF	32
#define ITCT_HDR_MCTLT_MSK	0xffff00000000
#define ITCT_HDR_RTOLT_OFF	48
#define ITCT_HDR_RTOLT_MSK	0xffff000000000000
...
#define HISI_SAS_MAX_ITCT_ENTRIES_V2_HW 2048
			     ...
			     struct hisi_sas_device *sas_dev)
{
	...
	qw0 |= ((1ULL << ITCT_HDR_VALID_OFF) |
		((u64)device->phy->negotiated_linkrate << ITCT_HDR_MCR_OFF) |
		(1ULL << ITCT_HDR_VLN_OFF) |
		((u64)device->port->id << ITCT_HDR_PORT_ID_OFF));
			      ...
			      struct hisi_sas_device *sas_dev)
{
	...
	for (i = 0; i < 2; i++) {
		...
		if (ENT_INT_SRC3_ITC_INT_MSK & reg_val) {
			dev_info(dev, "got clear ITCT done interrupt\n");
...
static int reset_hw_v2_hw(struct hisi_hba *hisi_hba)
{
	int i;
	u32 val;
	int reset_val = SAS0_RESET_VALUE;
	unsigned long end_time;
	struct device *dev = &hisi_hba->pdev->dev;

	if (hisi_hba->n_phy == HISI_SAS3_MAX_PHYS) {
...
static void init_reg_v2_hw(struct hisi_hba *hisi_hba)
{
	...
	for (i = 0; i < hisi_hba->n_phy; i++) {
		...
		if (of_get_property(np, "sas-timer-freq", NULL)) {
			   ...
			   struct hisi_sas_slot *slot)
{
	...
	u16 trans_rx_fail_type = cpu_to_le32(err_record->trans_tx_fail_type);
		...
		struct hisi_sas_slot *slot)
{
	...
	dw1 |= (get_ata_protocol(task->ata_task.fis.command,
				task->data_dir)) << CMD_HDR_FRAME_TYPE_OFF;
	dw1 |= (hisi_sas_dev->device_id) << CMD_HDR_DEV_ID_OFF;
	hdr->dw1 = cpu_to_le32(dw1);
		...
		int device_id, int abort_flag, int tag_to_abort)
{
	...
	/* dw7 */
	hdr->dw7 = cpu_to_le32(tag_to_abort
		...
		if (irq_msk & (1 << phy_id)) {
			...
			if (irq_value0) {
				if (irq_value0 & CHL_INT0_SL_RX_BCST_ACK_MSK)
					phy_bcast_v2_hw(phy_id, hisi_hba);
...
static int interrupt_init_v2_hw(struct hisi_hba *hisi_hba)
{
	...
	for (i = 0; i < 128; i++) {
		irq_map[i] = irq_of_parse_and_map(np, i);
	}
...
static const struct hisi_sas_hw hisi_sas_v2_hw = {
	...
	.max_itct_entries = HISI_SAS_MAX_ITCT_ENTRIES_V2_HW,
