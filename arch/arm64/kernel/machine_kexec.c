...
extern unsigned long arm64_kexec_dtb_addr_offset;
...
int machine_kexec_prepare(struct kimage *image)
{
	...
	dtb_addr = dtb_seg ? dtb_seg->mem : 0;
...
void machine_kexec(struct kimage *image)
{
	...
	memcpy(reboot_code_buffer + arm64_kexec_dtb_addr_offset,
	       &dtb_addr, sizeof(dtb_addr));
